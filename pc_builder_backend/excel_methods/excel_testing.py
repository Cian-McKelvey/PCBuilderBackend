...
# GPU DataFrame
gpu_dataframe = complete_parts_df.query('Type == "GPU"')
...
# RAM DataFrame
ram_dataframe = complete_parts_df.query('Type == "RAM"')
...
# HDD DataFrame
hdd_dataframe = complete_parts_df.query('Type == "HDD"')
...
motherboard_dataframe = complete_parts_df.query('Type == "Motherboard"')
...
ps_dataframe = complete_parts_df.query('Type == "Power Supply"')
...
# Case DataFrame
case_dataframe = complete_parts_df.query('Type == "Case"')
sample_case = case_dataframe.sample(n=1)
sample_case_name = sample_case.loc[sample_case.index[0], 'Name']
sample_case_price = sample_case.loc[sample_case.index[0], 'Price']
